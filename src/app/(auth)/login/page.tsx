    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-400 mt-2 text-sm">Accedi al tuo account</p>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-zinc-100 text-black font-medium py-3 px-4 rounded-xl transition-colors text-sm"
          >
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-zinc-500 text-xs">oppure</span>
            <div className="flex-1 h-px bg-zinc-800" />
          </div>
